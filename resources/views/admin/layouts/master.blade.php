...
<head>
    ...
    <link rel="stylesheet" href="{{asset('back-end/style.css')}}">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class=""><a href="{{url('/')}}"><i class="fa fa-dashboard"></i>Dashboard</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/admin/students')}}"><i class="fa fa-circle-o"></i> Students List</a></li>
                        <li><a href="{{url('/admin/students/create')}}"><i class="fa fa-circle-o"></i> Add List</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content" style="min-height: 902px">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy;  <a href="">Sumsunnahar Pritty</a>.</strong> All rights
        reserved.
    </footer>
